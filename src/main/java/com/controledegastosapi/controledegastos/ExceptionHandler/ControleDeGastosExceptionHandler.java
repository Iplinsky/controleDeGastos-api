...
@ControllerAdvice
public class ControleDeGastosExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<Object> handleRegraNegocioExcecao(RegraNegocioException ex, WebRequest request) {
